  ...
  <div class="min-h-screen bg-slate-50 text-gray-700">
    ...
    <main class="max-w-3xl mx-auto px-4 py-6">
        <template v-if="loading">
            <div class="p-4 rounded border border-slate-200 bg-white text-gray-600">Loading favorites…</div>
        </template>
        ...
        <template v-else-if="hasData">
            <div class="space-y-3">
                <div
                  ...
                  :key="f.asset_id"
                  class="relative flex overflow-hidden rounded-lg bg-white p-4 shadow-sm"
                >
                  ...
                  <button
                    class="ml-auto text-sm px-3 py-1 text-indigo-800 rounded border border-indigo-800"
        ...
        <template v-else>
            <div class="p-4 rounded border border-slate-200 bg-white text-gray-600">No favorites yet. Go to the Assets page and add some!</div>
        </template>
    </main>
  </div>
</template>
